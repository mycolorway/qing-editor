...
class Selection extends QingModule
  ...
  _setOptions: (opts) ->
    super
    $.extend @opts, Selection.opts, opts
  ...
  restore: ->
    ...
    startCaret = @editor.body.find('.qing-editor-caret-start')
    endCaret = @editor.body.find('.qing-editor-caret-end')
