...
class InputManager extends QingModule
  ...
  _setOptions: (opts) ->
    super
    $.extend @opts, InputManager.opts, opts
  ...
  _init: ->
    ...
    $(document).on 'selectionchange.qing-editor' + @editor.id, (e) =>
    ...
    @editor.on 'valuechanged', =>
      ...
      @editor.body.find('hr, pre, .qing-editor-table').each (i, el) =>
        $el = $(el)
